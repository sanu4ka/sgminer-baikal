...
#define PACKAGE_STRING "sgminer 5.5.0-b"
...
#define PACKAGE_VERSION "5.5.0-b"
...
/* Micro version */
#define SGMINER_MINOR_SUBVERSION 0
...
/* Defined to 1 if baikal support is wanted */
#define USE_BAIKAL 1
